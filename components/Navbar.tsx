    ...
    >
      ...
      <div className="flex md:hidden items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`text-xs transition-colors px-2 py-1 rounded min-w-[28px] ${
      ...
      <div className="hidden md:flex xl:hidden items-center justify-between px-4">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="bg-white text-blue-900 px-6 py-2 rounded-full hover:bg-gray-100 transition-colors text-sm font-bold whitespace-nowrap min-w-[140px]">
            {t("findDevice")}
          </button>
        </div>
      </div>
